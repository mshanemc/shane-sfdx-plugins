...
`
  ...
  protected static flagsConfig = {
    ...
    durationdays: { type: 'string',  char: 'd', default: '7', description: 'duration of the scratch org (in days) (default:7, min:1, max:30)' },
    wait: { type: 'string', description: 'the streaming client socket timeout (in minutes) (default:20, min:2)' },

...
export default class DataTreeImport extends SfdxCommand {
  ...
  public static description = 'similr to the original tree:import, but handles more than 200 records at a go, while still preserving relationships.  Takes longer.';
